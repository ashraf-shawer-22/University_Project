        ...
        <div class="holder">
            ...
            <script>
                ...
                function loadAttendance(selectedDate = null) {
                    ...
                    const year = 1; // Change this dynamically if needed for different levels
                    let url = `/attendance?year=${year}`;
                ...
                // Load attendance for all students in Level 1 on page load
